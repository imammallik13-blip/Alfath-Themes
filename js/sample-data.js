...
//
// Struktur mengikuti skema tabel `themes` di Supabase versi
// terbaru: 1 tema bisa punya beberapa VARIAN (kategori aplikasi
// WA / gaya emoji, dst) dengan harga dan galeri foto masing-masing.
//   theme.category      -> kategori produk (Wallpaper/Font/dst),
//                          dipakai buat filter bar
//   theme.variants[]    -> { id, label, price, preview_images[] }
// ============================================================
    ...
    variants: [
      {
        ...
        label: "Standar",
        price: 8000,
        preview_images: ["https://images.unsplash.com/photo-1516259762381-22954d7d3ad2?w=600&h=450&fit=crop"]
      }
    ]
  },
  {
